...
<html lang="en">
  <head>
    ...
    <title>
        <?php 
            if(isset($title))
                ...
                echo "Bếp tốt - Bếp của mọi nhà";
        ?>
    </title>
    <link rel="icon" type="image/x-icon" href="public/images/logo_test_10.png">
    ...
    <body>
        ...
        <div class='scrolltop'>
        <div style="background-color: blue" class='scroll icon'><i class="fa fa-4x fa-angle-up"></i></div>
        </div>
    </body>
</html>
