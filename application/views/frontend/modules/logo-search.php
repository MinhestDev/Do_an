<section class="logo-search">
  <div class="container">
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo">
      <a href="<?php echo base_url() ?>"><img style="margin-top:30px; background: blue" src="<?php echo base_url() ?>public/images/logo_test_10.png" alt="Logo Shop"></a>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i style="color: blue;" class="icon fa fa-phone"></i> (0123) 456 789
        </div>
        <div class="contact inline">
          <i style="color: blue;" class="icon fa fa-envelope"></i> beptot@gmail.com
        </div>
      </div>
      <form action="search" method="get" role="form">
        <div class="input-search">
          <input style="border: 1px solid blue" type="text" class="form-control" id="search_text" name="search" placeholder="Nhập từ khóa để tìm kiếm...">
          <button style="background-color:blue;">
              <i style="border: blue" class="fa fa-search"></i>
            </button>
          </div>
        </form>
      </div>
