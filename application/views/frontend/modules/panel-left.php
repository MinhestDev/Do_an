<div class="menu-pri" style="background-color: blue;">
    <div class="container">
        <div class="panel-left" style="background: blue;">
            <!--MOBILE-->
        ...
        <div class="col-md-12 col-lg-12 panel-right hidden-xs text-center" style="background: blue;">
