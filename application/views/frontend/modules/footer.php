    ...
    <div class="container">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                <a href="trang-chu">
                    <img src="public/images/logo_test_10.png" style="width: 100%;" class="img-fix f-logo" alt="smart-construction">
                </a>
                <div class="about-store">
                 Bếp tốt - Bếp của mọi nhà
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="clearfix">
                        ...
                        <span><a href="#">beptot@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
