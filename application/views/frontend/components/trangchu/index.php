    ...
    <div class="slider">
        <div class="container">
           <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 list-menu pull-left" style="height: 321px;">
             ...
             <img style="width: 100%; height: 160px;" src="public/images/bottom_banner.png">
         </div>
...
<div class="container" style="margin-top: 20px;">
    <div class="sale-title" style="background-color: blue;">
        <span>SẢN PHẨM HOT</span>
    </div>
</div>
<div class="container" style="margin-bottom: 20px;">
    <div class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid blue;">
        <?php 
    ...
    <div class="container">
        <div class="row-p">
            <div class="text-center">
                <h2 class="sectin-title title title-blue">Tin tức sản phẩm</h2>
            </div>
        </div>
        <div class="blog-content">
            ...
            foreach ($listBaiViet as $rowPost) :?>
                <div class="col-xs-12 col-12 col-sm-6 col-md-4 col-lg-4" style="margin: 5px;width: 370px">
                    <div class="latest">
